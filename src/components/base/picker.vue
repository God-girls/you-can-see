...
<script>
  export default{
    ...
    methods: {
      ...
      finish (e) {
        setTimeout(()=>{
          // alert(JSON.stringify(this.selects.select1))
          this.setTop([ // 默认显示哪一个字段
            {
              text: this.selects.select1.text,
              value: this.selects.select1.value
            }
          ])
        },300)
      ...
      gearTouchMove(e) {
        ...
        target.style["-webkit-transform"] = 'translateY(' + target["pos_" + target.id] + 'rem)';
      ...
      rollGear(target) {
        ...
        target["int_" + target.id] = setInterval(function () {
          ...
          target.style["-webkit-transform"] = 'translateY(' + pos + 'rem)';
      ...
      setTop(defaultData) {
        this.$nextTick(()=> {
          ...
          if (defaultData[0] && (defaultData[0].value)) {
            ...
            province.style.transform = province.style["-webkit-transform"] = 'translateY(' + pos1 + 'rem)';
      ...
      resetData2(endVal) {
        this.$nextTick(()=> {
          ...
          city.style["-webkit-transform"] = 'translateY(0)';
        })
      },
      resetData3(endVal) {
        this.$nextTick(()=> {
          ...
          county.style["-webkit-transform"] = 'translateY(0)';
        })
      },
      init() {
        if (!this.selectData.link) {
        ...
        if (this.selectData.columns === 1) {
          ...
          // alert(JSON.stringify(this.selectData.default))
          this.setTop(this.selectData.default);
...
.area_roll {
  ...
  -webkit-mask: -webkit-gradient(linear, 0% 70%, 0% 100%, from(#debb47), to(rgba(36, 142, 36, 0)));
  -webkit-mask: -webkit-linear-gradient(top, #debb47 70%, rgba(36, 142, 36, 0))
}
...
.area_roll_mask {
  -webkit-mask: -webkit-gradient(linear, 0% 80%, 0% 0%, from(#debb47), to(rgba(36, 142, 36, 0)));
  -webkit-mask: -webkit-linear-gradient(bottom, #debb47 80%, rgba(36, 142, 36, 0));
  padding: 0
}
