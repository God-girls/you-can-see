// 三个id，互不干扰，新增的按照顺序分别从50、500、3000开始  目前已经加到50、565、3223 PS：不允许出现重复id
var map = [
  {id: 1,
    name: '北京',
    city: [
      ...
      {id: 501,
        name: '朝阳区',
        district: [
          {id: 3002, name: '三环到四环之间'},
          {id: 3003, name: '四环到五环之间'},
          {id: 3004, name: '五环到六环之间'},
          {id: 3005, name: '管庄'},
          {id: 3006, name: '北苑'},
          {id: 3007, name: '定福庄'},
          {id: 3008, name: '三环以内'}
      ...
      {id: 504,
        ...
        district: [
          {id: 3014, name: '三环以内'},
          {id: 3015, name: '三环到四环之间'},
          {id: 3016, name: '四环到五环之间'},
          {id: 3017, name: '五环到六环之间'},
          {id: 3018, name: '六环以外'},
          {id: 3019, name: '西三旗'},
          {id: 3020, name: '西二旗'}
        ]
      ...
      {id: 509,
        ...
        district: [
          {id: 3027, name: '二环到三环'},
          {id: 3028, name: '三环到四环之间'},
          {id: 3029, name: '四环到五环之间'},
          {id: 3030, name: '五环到六环之间'},
          {id: 3031, name: '六环以外'}
        ]
      },
      {id: 510,
      ...
      {id: 513,
        name: '通州区',
        district: [
          {id: 3068, name: '六环内（马驹桥镇）'},
          {id: 3069, name: '中仓街道'},
          {id: 3070, name: '新华街道'},
          {id: 3071, name: '玉桥街道'},
          {id: 3072, name: '北苑街道'},
          {id: 3073, name: '六环外（马驹桥镇）'},
          {id: 3074, name: '永顺镇'},
          {id: 3075, name: '梨园镇'},
          {id: 3076, name: '宋庄镇'},
          {id: 3077, name: '郭县镇'},
      ...
      {id: 515,
        name: '大兴区',
        district: [
          {id: 3101, name: '四环到五环之间'},
          {id: 3102, name: '五环到六环之间'},
          {id: 3103, name: '六环以外'},
          {id: 3104, name: '亦庄经济开发区'}
        ]
      },
      {id: 516,
        name: '顺义区',
  ...
  {id: 2,
    ...
    city: [
      ...
      {id: 563,
        name: '北辰区',
        district: [
          {id: 3152, name: '外环外双街镇，河北工大新校，屈店工业园'},
          {id: 3153, name: '外环内'},
          {id: 3154, name: '外环外其他地区'}
        ]
      },
      {id: 564,
        name: '宝坻区',
        district: [
          {id: 3155, name: '城关镇、马家店开发区、天宝工业园'},
          {id: 3156, name: '其它地区'}
        ]
      },
      {id: 565,
  ...
  {id: 31,
    ...
    city: [
      ...
      {id: 339, name: '石河子市', district: [{id: 3217, name: '石河子市'}]},
      {id: 340, name: '阿拉尔市', district: [{id: 3218, name: '阿拉尔市'}]},
      {id: 341, name: '图木舒克市', district: [{id: 3219, name: '图木舒克市'}]},
      {id: 342, name: '五家渠市', district: [{id: 3220, name: '五家渠市'}]}
    ]},
  {id: 32,
    name: '香港',
    city: [
      {id: 343, name: '香港', district: [{id: 3221, name: '香港特别行政区'}]}
    ]},
  {id: 33,
    name: '澳门',
    city: [
      {id: 344, name: '澳门', district: [{id: 3222, name: '澳门特别行政区'}]}
    ]},
  {id: 34,
    name: '台湾',
    city: [
      {id: 345, name: '台湾', district: [{id: 3223, name: '台湾'}]}
    ]}
